...
@app.get("/workspace/{workspace_id}", response_model=schemas.Workspace)
...
@app.put("/workspace/user", response_model=schemas.Workspace)
...
@app.delete("/workspace/user", response_model=schemas.Workspace)
